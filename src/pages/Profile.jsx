...
const Profile = () => {
  ...
  if (!user) {
    ...
    var formatted = date.toLocaleDateString("en-IN", {
      day: "2-digit",
      month: "short",
      year: "numeric",
    });
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-6 text-center md:text-left">
            ...
            <div className="flex flex-wrap gap-3 w-full md:w-auto justify-center md:justify-end">
              <button
                ...
                className="flex-1 md:flex-none min-w-35 bg-primary-600/10 hover:bg-primary-500 text-primary-400 hover:text-white px-5 py-3 rounded-lg font-medium text-[11px] flex items-center justify-center gap-2 border border-primary-500/20 transition-all active:scale-95 shadow-lg shadow-primary-900/10"
              >
                <Edit3 size={12} />
                Update Profile
              </button>
          ...
          <div className="mt-6 space-y-6 text-center md:text-left">
            ...
            {/* <div className="flex justify-around md:justify-start gap-6 md:gap-10 pt-4 border-t border-white/5">
              <div className="flex flex-col gap-0.5">
                <span className="text-[10px] md:text-[12px] font-medium text-slate-500">
                  Reach
                </span>
          ...
          <div className="flex gap-4 md:gap-8 min-w-max px-1">
            {tabs.map((tab) => (
              ...
              >
                ...
                />
                <span
                  className={`text-[11px] md:text-[12px] font-medium ${activeTab === tab.id ? "text-white" : "text-slate-500 group-hover:text-slate-400"}`}
                >
                  {tab.label}
                </span>
