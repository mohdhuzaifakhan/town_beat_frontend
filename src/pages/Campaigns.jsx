        ...
        <div className="space-y-6 max-w-5xl mx-auto px-4 pb-20">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
                <div className="space-y-1 max-w-full overflow-hidden">
                    <h1 className="text-xl font-medium flex items-center justify-center md:justify-start gap-3 max-w-full">
                        ...
                        <span className="truncate">Movements</span>
                        <span className="text-[11px] md:text-[12px] text-slate-600 font-medium ml-2 opacity-50 shrink-0">Pulse Signal</span>
                    </h1>
                    <p className="text-[10px] md:text-[11px] font-medium text-slate-600 md:ml-9 truncate">Authorized Community Action Protocol</p>
                </div>
                {user && (
                    <button
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-20 space-y-3">
                    ...
                    <p className="text-slate-400 text-[12px] font-medium">Synchronizing Signals...</p>
                </div>
            ) : (
