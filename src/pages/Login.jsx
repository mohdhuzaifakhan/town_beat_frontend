        ...
        <div className="w-full flex flex-col justify-center p-8 px-2 sm:p-4 lg:p-16 relative z-10">
          <div className="mb-10 text-center md:text-left">
            ...
            <p className="text-[12px] text-slate-500">
              Go to your <span className="text-primary-500">TownBeat</span> account
            </p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-slate-950/80 border border-white/10 rounded-lg px-5 py-3 pl-14 text-[12px] text-white placeholder:text-slate-500 focus:outline-none focus:border-primary-500/40 transition-all shadow-inner"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between mb-1 px-1">
                ...
                <button
                  ...
                  className="text-[12px] font-medium text-primary-500 hover:text-primary-400"
                >
                  Forgot password?
                </button>
              </div>
              <div className="relative group">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 flex items-center gap-4">
                  <Lock className="w-4 h-4 text-slate-600 group-focus-within:text-primary-500 transition-colors" />
                  <div className="w-px h-4 bg-white/5" />
                </div>
                <input
                  type="password"
